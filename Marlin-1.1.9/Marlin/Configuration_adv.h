 ...
 */
#define ADVANCED_PAUSE_FEATURE //GS
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. //GS
  #define HOME_BEFORE_FILAMENT_CHANGE           // Ensure homing has been completed prior to parking for filament change //GS
